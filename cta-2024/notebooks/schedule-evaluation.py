...
directory = "/Users/moji/Projects/transit_lab_simmetro/cta-2024/schedule-evaluation/"
...
data = {}
data["AM"] = all_data[
    "period=version_83,scen=schedule-evaluation,schd=AM,station=NO-CONTROL"
]
data["PM"] = all_data[
...
for schd, df in data.items():
    ...
    fig.update_layout(
        ...
        yaxis=dict(ticksuffix="%", range=[0, 6]),
