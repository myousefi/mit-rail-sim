...
if TYPE_CHECKING:
    from transit_lab_simmetro.simulation_engine.infrastructure import BlockType
    from transit_lab_simmetro.simulation_engine.train import TrainSpeedRegulator
