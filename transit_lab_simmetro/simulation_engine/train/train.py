...
if TYPE_CHECKING:
    from transit_lab_simmetro.simulation_engine.train.train_passenger_manager import (
    ...
    from transit_lab_simmetro.simulation_engine.train.train_state import TrainState
